    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        <div className="bg-white/[0.03] rounded-xl p-3 text-center">
          <p className="text-[10px] text-zinc-500">{t("metrics.recovery")}</p>
          <p className="text-lg font-semibold text-emerald-400">{brief.recoveryAvg}%</p>
        </div>
        <div className="bg-white/[0.03] rounded-xl p-3 text-center">
          <p className="text-[10px] text-zinc-500">{t("metrics.sleep")}</p>
          <p className="text-lg font-semibold text-violet-400">{brief.sleepAvg}h</p>
        </div>
        <div className="bg-white/[0.03] rounded-xl p-3 text-center">
          <p className="text-[10px] text-zinc-500">{t("metrics.strain")}</p>
      ...
      <div className="mb-4">
        <div className="flex justify-between text-[10px] text-zinc-500 mb-1">
          <span>{t("trends.weeklyStrainVs", { target: brief.strainTarget })}</span>
      ...
      <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-xl px-3 py-2.5">
        <p className="text-[10px] text-cyan-400 uppercase tracking-wider mb-0.5">
          {t("trends.weeklyFocus")}
        </p>
