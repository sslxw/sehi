  ...
  return (
    <div className="space-y-6">
      <div className="glass rounded-2xl p-4">
        <h3 className="text-sm font-semibold text-zinc-200 mb-1">Today&apos;s check-in</h3>
        <p className="text-xs text-zinc-500 mb-4">
          Log habits to refine your Sehi Score and unlock correlations
        </p>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-zinc-200">{factor.label}</p>
                    <p className="text-[10px] text-zinc-500">{factor.impact}</p>
                  </div>
                </div>
                {isToggle ? (
                  <button
      ...
      <div>
        <h3 className="text-sm font-semibold text-zinc-300 mb-3">Your correlations</h3>
        <div className="space-y-2">
          {correlations.map((c, i) => (
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                <span className="text-sm font-medium text-zinc-200">{c.factor}</span>
                <span
                  className={cn(
              ...
              <p className="text-xs text-zinc-400">{c.impact}</p>
            </motion.div>
          ))}
        </div>
      </div>
